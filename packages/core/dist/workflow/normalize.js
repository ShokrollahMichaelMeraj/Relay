...
exports.validateUniqueTaskIds = validateUniqueTaskIds;
exports.validateTaskReferences = validateTaskReferences;
/**
 ...
 */
function validateUniqueTaskIds(workflow) {
    const ids = new Set();
    const duplicates = [];
 ...
 */
function validateTaskReferences(workflow) {
